...
#define setPosX(v,x)                v.frame = CGRectMake(x, posY(v), width(v), height(v))
#define setPosY(v,y)                v.frame = CGRectMake(posX(v), y, width(v), height(v))
#define setFramePosition(v,x,y)     v.frame = CGRectMake(x, y, width(v), height(v))
#define setFrameSize(v,w,h)         v.frame = CGRectMake(xPos(v), yPos(v), w, h)
#define setBoundsPosition(v,x,y)    v.bounds = CGRectMake(x, y, width(v), height(v))
#define setBoundsSize(v,w,h)        v.bounds = CGRectMake(xPos(v), yPos(v), w, h)
